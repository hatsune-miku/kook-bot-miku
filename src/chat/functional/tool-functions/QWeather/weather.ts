...
export async function queryRealtimeWeather(locationId: string): Promise<FriendlyWeatherResponse> {
...
export function createFriendlyWeatherResult(result: WeatherResponse): FriendlyWeatherResponse {
  return [
